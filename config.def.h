...
const unsigned int keyboardscrollincrement = 3;
static Shortcut shortcuts[] = {
    ...
    { MODKEY,              XK_Up,          kscrollup,      {.i = keyboardscrollincrement} },
    { MODKEY,              XK_k,           kscrollup,      {.i = keyboardscrollincrement} },
    { MODKEY,              XK_Down,        kscrolldown,    {.i = keyboardscrollincrement} },
    { MODKEY,              XK_j,           kscrolldown,    {.i = keyboardscrollincrement} },
